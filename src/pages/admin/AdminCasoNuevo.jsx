...
const s = {
  ...
  grid2: { display: "flex", gap: 24, flexWrap: "wrap" },
  columna: { flex: "1 1 340px", minWidth: 300 },
  h3: { fontSize: 14, marginBottom: 10 },
  list: { display: "flex", flexDirection: "column", gap: 6, marginBottom: 14 },
  itemOrdenado: { display: "flex", alignItems: "center", gap: 10, background: "#16213A", border: "1px solid rgba(244,241,233,0.1)", borderRadius: 8, padding: "9px 12px" },
  itemEnEdicion: { border: "1px solid #4FC3D9" },
  orden: { display: "inline-flex", alignItems: "center", justifyContent: "center", width: 22, height: 22, borderRadius: "50%", background: "rgba(79,195,217,0.15)", color: "#4FC3D9", fontSize: 11, fontWeight: 700, flexShrink: 0 },
  itemTexto: { flex: 1, fontSize: 13, margin: 0, color: "#F4F1EA" },
  editarBtn: { background: "none", border: "1px solid rgba(244,241,233,0.2)", borderRadius: 6, color: "#94A3B8", padding: "5px 10px", fontSize: 12, cursor: "pointer" },
  ...
  fundamentoCard: { background: "#16213A", border: "1px solid rgba(244,241,233,0.12)", borderRadius: 12, padding: 18, marginBottom: 14, maxWidth: 640 },
  ordenGrande: { fontSize: 11, color: "#4FC3D9", textTransform: "uppercase", fontWeight: 700, margin: "0 0 4px" },
  guardadoTexto: { color: "#7FB685", fontSize: 12.5, margin: "8px 0" },
  fuentes: { fontSize: 12, color: "#94A3B8", margin: "8px 0 0" },
  finBtn: { marginTop: 10, background: "none", border: "1px solid rgba(244,241,233,0.2)", borderRadius: 8, color: "#F4F1EA", padding: "12px 20px", fontSize: 14, cursor: "pointer" },
};
