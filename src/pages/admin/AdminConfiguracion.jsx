...
export default function AdminConfiguracion() {
  ...
  return (
    <div style={s.wrap}>
      ...
      <div style={s.list}>
        <button onClick={() => navigate("/admin/interrogadores")} style={s.btn}>
          <span style={s.letra}>A</span>
          <div>
            <p style={s.btnTitulo}>Interrogadores</p>
            <p style={s.btnDesc}>Crear cuentas de interrogador o administrador</p>
          </div>
        </button>

        <button onClick={() => navigate("/admin/conjuntos")} style={s.btn}>
          <span style={s.letra}>B</span>
          <div>
            <p style={s.btnTitulo}>Conjuntos y alumnos</p>
